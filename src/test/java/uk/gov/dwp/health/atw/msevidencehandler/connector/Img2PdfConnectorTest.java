...
@SpringBootTest(classes = Img2PdfConnector.class)
public class Img2PdfConnectorTest {
  ...
  void successfulConversion() throws URISyntaxException, FileConversionToPdfException {
    ...
    when(config.getImg2pdf()).thenReturn(new ServiceConfig("http://host:1234"));
